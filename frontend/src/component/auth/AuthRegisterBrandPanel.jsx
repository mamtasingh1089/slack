...
const AuthRegisterBrandPanel = () => {
  ...
  return (
    <div
      ...
      className="hidden lg:flex lg:w-1/2 relative flex-col justify-between overflow-hidden border-l border-[#F0E5DC] h-screen bg-[#FFFBF7] pt-12 px-12 xl:pt-16 xl:px-16 pb-0 select-none cursor-default"
    >
      
      {/* Sunset Golden Hour Sky Transition Layer */}
      {!shouldReduceMotion && (
        <motion.div
      ...
      <motion.img
        src={TopLeftCloud}
        alt=""
        className="absolute top-0 left-0 w-[260px] xl:w-[320px] opacity-75 pointer-events-none z-0"
        initial={shouldReduceMotion ? {} : { opacity: 0, x: -30 }}
        animate={shouldReduceMotion ? { opacity: 0.75 } : { opacity: 0.75, x: 0 }}
      ...
      >
        <div className="flex gap-1.5">
          <span className="w-1.5 h-1.5 rounded-full bg-[#E58004]"></span>
          <span className="w-1.5 h-1.5 rounded-full bg-[#E58004]"></span>
          <span className="w-1.5 h-1.5 rounded-full bg-[#E58004]"></span>
        </div>
        <div className="flex gap-1.5">
      ...
      <motion.img
        src={Cloud1}
        alt=""
        className="absolute right-[-70px] bottom-[14%] w-[260px] xl:w-[300px] opacity-80 pointer-events-none z-0"
      ...
      <motion.img
        src={Cloud2}
        alt=""
        className="absolute right-[70px] bottom-[6%] w-[180px] xl:w-[210px] opacity-80 pointer-events-none z-0"
        style={shouldReduceMotion ? {} : { x: parallaxBgCloudX, y: parallaxBgCloudY }}
        initial={shouldReduceMotion ? {} : { scale: 0.8, opacity: 0 }}
        animate={{ scale: 1, opacity: 0.8 }}
      ...
      {/* UPPER SECTION: Brand Logo & Details */}
      <motion.div
      ...
      >
        ...
        <div className="flex flex-col justify-center -ml-5 xl:-ml-7">
          ...
          <p className="text-xs font-semibold text-[#5F6F69] tracking-wider mt-0">
            Communicate <span className="text-[#F28B06]">•</span> Collaborate <span className="text-[#119480]">•</span> Create
          </p>
        </div>
      </motion.div>
      ...
      <div className="absolute bottom-0 left-0 right-0 w-full h-[220px] xl:h-[260px] pointer-events-none select-none z-10 overflow-hidden">
        ...
        <motion.img
          src={Sun}
          alt=""
          className="absolute bottom-[24%] left-[18%] w-[65px] xl:w-[75px] h-auto z-5 hue-rotate-[15deg] saturate-150"
        ...
        <motion.img
          src={City}
          alt=""
          className="absolute bottom-[18%] left-[24%] w-[260px] xl:w-[320px] h-auto opacity-60 z-5 sepia saturate-150"
        ...
        <motion.img
          src={FourthHill}
          alt=""
          className="absolute bottom-0 left-0 w-full h-auto object-cover object-bottom z-10 scale-x-105 hue-rotate-[25deg] saturate-75"
        ...
        <motion.img
          src={ThirdHill}
          alt=""
          className="absolute bottom-0 left-0 w-full h-auto object-cover object-bottom z-20 scale-x-105 hue-rotate-[25deg] saturate-75"
        ...
        <motion.img
          src={FirstHill}
          alt=""
          className="absolute bottom-0 left-0 w-full h-auto object-cover object-bottom z-30 scale-x-105 hue-rotate-[25deg] saturate-75"
        ...
        <motion.img
          src={SecondHill}
          alt=""
          className="absolute bottom-0 left-0 w-full h-auto object-cover object-bottom z-40 scale-x-105 hue-rotate-[25deg] saturate-75"
        ...
        <motion.img
          src={LeftLeaves}
          alt=""
          className="absolute bottom-0 left-0 w-[12%] max-w-[80px] h-auto object-contain z-50 origin-bottom-left hue-rotate-[15deg] sepia"
        ...
        <motion.img
          src={RightLeaves}
          alt=""
          className="absolute bottom-0 right-0 w-[20%] max-w-[130px] h-auto object-contain z-50 origin-bottom-right hue-rotate-[15deg] sepia"
...
export default AuthRegisterBrandPanel;
